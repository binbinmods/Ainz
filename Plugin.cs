...
namespace Ainz
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Ainz";
        public static string heroName = characterName;

        public static string subclassName = "Overlord"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Ainz, the Overlord.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Ainz",
                _contentFolder: "Ainz",
